"""
Django settings for mrbill project.
...
SECRET_KEY = 'z*w8w1c+f!0+-tey_u^0$s^n!9zs9s6nm!k#3vb)#!ip@n#pbe'
...
WSGI_APPLICATION = 'mrbill.wsgi.application'
